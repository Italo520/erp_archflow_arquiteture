    ...
    return (
        <div className="mt-8">
            <div className="flex items-center gap-2 mb-4 border-b border-gray-200 dark:border-[#264532] pb-2">
                ...
                <h3 className="text-foreground text-lg font-bold">Minhas Notificações</h3>
            </div>
            ...
            <div className="flex flex-col gap-3">
                {NOTIFICATION_EVENTS.map(event => {
                    ...
                    return (
                        <div key={event.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-[#264532]/30 rounded-xl border border-border">
                            <div>
                            ...
                            >
                                <span
                                    className={`inline-block h-4 w-4 transform rounded-full bg-card transition-transform ${enabled ? 'translate-x-6' : 'translate-x-1'}`}
                                />
                            </button>
                        </div>
                    );
