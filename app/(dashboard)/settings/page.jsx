        ...
        <div className="flex-1 layout-container flex flex-col max-w-[1280px] mx-auto w-full px-4 lg:px-8 py-6">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-1">
                                    <button 
                                        ...
                                        className={`flex items-center gap-3 px-3 py-3 rounded-full transition-all w-full text-left ${activeTab === 'profile' ? 'bg-primary text-background-dark shadow-lg shadow-primary/20 font-bold' : 'text-slate-700 dark:text-white hover:bg-gray-100 dark:hover:bg-[#264532] font-medium'}`}
                                    >
                                    ...
                                    <button 
                                        ...
                                        className={`flex items-center gap-3 px-3 py-3 rounded-full transition-all w-full text-left ${activeTab === 'security' ? 'bg-primary text-background-dark shadow-lg shadow-primary/20 font-bold' : 'text-slate-700 dark:text-white hover:bg-gray-100 dark:hover:bg-[#264532] font-medium'}`}
                                    >
                                    ...
                                    <button 
                                        ...
                                        className={`flex items-center gap-3 px-3 py-3 rounded-full transition-all w-full text-left ${activeTab === 'notifications' ? 'bg-primary text-background-dark shadow-lg shadow-primary/20 font-bold' : 'text-slate-700 dark:text-white hover:bg-gray-100 dark:hover:bg-[#264532] font-medium'}`}
                                    >
                ...
                <main className="flex-1 flex flex-col gap-6 min-w-0">
                    ...
                    {activeTab === 'security' && (
                        <div className="bg-white dark:bg-surface-dark rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-transparent text-center">
                            ...
                            <p className="text-gray-500">Página de segurança em construção.</p>
                        </div>
                    )}
